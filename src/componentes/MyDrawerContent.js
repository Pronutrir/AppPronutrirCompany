    ...
    return (
        <View style={styles.container}>
            <View style={styles.box1}>
                <Image style={styles.imgLogo} source={require('../assets/imagens/PRONUTRIR-preview.png')} />
                <Text style={styles.text1}>Bem Vindo</Text>
                <Text style={styles.text2}>{usertasy ? usertasy.nM_PESSOA_FISICA : null}</Text>
                <Text style={styles.text2}>{usertasy ? `*** . *** . ${usertasy.nR_CPF.substring(6, 9)}-${usertasy.nR_CPF.substring(9, 11)}` : null}</Text>
            </View>
            ...
            <View style={styles.box3}>
                ...
                <Text style={styles.text2}>Versão 1.0</Text>
            </View>
