...
const useGetFamiliar = (codPfPaciente: string) => {
  ...
  return useQuery(
    ...
    },
    {
      ...
      onError: () => {
        addAlert({
          message: 'Error ao adicionar o acompanhante tente mais tarde!',
          status: 'error',
        });
      },
    },
  ...
  return useMutation(
    ...
    },
    {
      onSuccess: dataResult => {
        ...
        if (MSG === 'A Pessoa fisica já possui cadastro na base de dados!') {
          return;
        } else {
          addAlert({
      ...
      onError: error => {
        addAlert({
          message: 'Error ao adicionar  os sinais vitais tente mais tarde!',
          status: 'error',
        });
      },
    },
  ...
  return useMutation(
    ...
    },
    {
      ...
      onError: error => {
        console.log(error);
        addAlert({
          message: 'Error ao vincular os sinais vitais tente mais tarde!',
          status: 'error',
        });
      },
    },
