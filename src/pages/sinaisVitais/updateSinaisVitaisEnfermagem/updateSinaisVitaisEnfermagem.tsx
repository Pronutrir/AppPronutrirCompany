...
import ModalCentralize from '../../../components/Modais/ModalCentralize';
...
const UpdateSinaisVitaisEnfermagem: React.FC<Props> = ({
  ...
  const ChangerProperty = () => {
    let x = false;
    x = Altura !== 0 || Peso !== 0 || oxigenacao !== 50 || temperatura !== 30;
    return x;
  };
            ...
            <>
              <TouchableShowHide TextHeader={'Antropometria'}>
                <View style={styles.item2}>
                  <ToggleSwitch
                    onpress={() =>
                      setDisabledAntropometria(!disabledAntropometria)
                    }
                  />
                  <SlideRanger
                    label={'Altura'}
              ...
              <TouchableShowHide TextHeader={'Sinais vitais'}>
                <View style={styles.item2}>
                  <ToggleSwitch
                    onpress={() =>
                      setDisabledSinaisVitais(!disabledSinaisVitais)
                    }
                ...
                <View style={styles.item2}>
                  <ToggleSwitch
                    onpress={() => setDisabledTemperatura(!disabledTemperatura)}
              ...
              <TouchableShowHide TextHeader={'Registro de dor'}>
                <View style={styles.item2}>
                  <ToggleSwitch
                    onpress={() => setDisabledRegistroDor(!disabledRegistroDor)}
              ...
              <TouchableShowHide TextHeader={'Monitorização geral'}>
                <View style={styles.item2}>
                  <ToggleSwitch
                    onpress={() =>
                      setDisabledMonitorizacao(!disabledMonitorizacao)
                    }
