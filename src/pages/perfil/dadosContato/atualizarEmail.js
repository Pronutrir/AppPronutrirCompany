                ...
                if (result) {
                    setModalNotification((prevState) => {
                        return {
                            ...prevState,
                            active: true,
                            message: 'O Seu E-mail foi atualizado com sucesso!',
                            type: 'success',
                        };
                    });
                    dispatchAuth({
                        type: 'UpdateUserTasyEmail',
                        payload: result.dS_EMAIL,
                    });
                }
                return result;
            })
    ...
    const atualizarDados = async (values) => {
        ...
        if (result) {
            try {
                ...
                const upFirebase = await updateEmailFirebase(
                    values.Email,
                    cd_firestone,
                );
                setLoadingActive(false);
