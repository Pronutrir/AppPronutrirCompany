...
export default function alterarSenha({ navigation }) {
    ...
    const UpdateSenha = async (value, { resetForm }) => {
        ...
        user.updatePassword(value.Senha).then(response => {
            setModalNotification(prevState => {
                return { ...prevState, active: true, message: 'Senha alterada com sucesso!', type: 'success' }
            });
            setModalActive(false);
            resetForm();
        }).catch(error => {
            setModalNotification(prevState => {
                return { ...prevState, active: true, message: 'Erro ao alterar a senha, tente mais tarde!', type: 'error' }
            });
            setModalActive(false);
        });
    }
                                                ...
                                                <View style={styles.item1}>
                                                    ...
                                                    <View style={styles.sectionInput}>
                                                        <TextInput
                                                            ...
                                                            maxLength={40}
                                                        />
                                                        <VisaoPassword active={showPassword1} setActive={setShowPassword1} />
                                                    </View>
                                ...
                                {({ handleChange, handleBlur, handleSubmit, values, errors, touched, isValid, }) => (
                                    <View style={{ flex: 1 }} >
                                        <KeyboardAvoidingView
                                            style={{ flex: 1 }}
                                            behavior={Platform.OS === "ios" ? "height" : "height"}
                                            keyboardVerticalOffset={Dimensions.get('screen').height / 5}
                                        >
                                            <View style={styles.box1}>
                                                <View style={styles.item1}>
                                                ...
                                                <View style={styles.item1}>
                                                    ...
                                                    <View style={styles.sectionInput}>
                                                        <TextInput
                                                            ...
                                                            maxLength={40}
                                                        />
                                                        <VisaoPassword active={showPassword2} setActive={setShowPassword2} />
                                                    </View>
