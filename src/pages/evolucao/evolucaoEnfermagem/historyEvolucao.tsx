      ...
      <PressableRipple
        ...
        <View style={styles.box2}>
          <View style={styles.item}>
            ...
            <Text
              style={styles.text}>{`${item.nM_PACIENTE.toUpperCase()}`}</Text>
          </View>
          <View style={styles.item}>
            <Text style={styles.textLabel}>Data da evolução: </Text>
            <Text style={styles.text}>{`${moment(item.dT_EVOLUCAO).format(
              'DD-MM-YYYY [às] HH:mm',
            )}`}</Text>
          </View>
          <View style={styles.item}>
        ...
        <View style={styles.box3}>
          <View style={{ alignItems: 'flex-end' }}>
            <MenuPopUp
              ...
              onpress={label => {
                refMenuBotom.current?.hideMenu(), MenuPopUpOptions(label, item);
              }}
            />
          </View>
          <View>
